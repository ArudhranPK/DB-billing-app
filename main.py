...
def show_bill_page():
    ...
    display_button=Button(left_side_frame,text = "DISPLAY BILL",background = green ,foreground = black, command = lambda : show_bill_validation())
...
def add_bill_page():
    ...
    label_bill_number = Label(left_side_frame, text = "Bill Number:", foreground = white, background = black)
